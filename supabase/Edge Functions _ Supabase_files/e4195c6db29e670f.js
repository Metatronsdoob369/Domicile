;!function(){try { var e="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof global?global:"undefined"!=typeof window?window:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&((e._debugIds|| (e._debugIds={}))[n]="485f2877-b4b2-261e-fce7-11590bc3947a")}catch(e){}}();
(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,528462,e=>{"use strict";var t=e.i(478902),a=e.i(311827),i=e.i(543851),s=e.i(300906),n=e.i(219195),r=e.i(843778),o=e.i(792459);e.s(["EntityTypeIcon",0,({type:e,size:l=15,strokeWidth:c=1.5,isActive:u})=>"sql"===e?(0,t.jsx)(o.SQL_ICON,{size:l,className:(0,r.cn)("transition-colors","fill-foreground-muted","group-aria-selected:fill-foreground","w-4 h-4","-ml-0.5"),strokeWidth:c}):e===a.ENTITY_TYPE.TABLE?(0,t.jsx)(n.Table2,{size:l,strokeWidth:c,className:(0,r.cn)("text-foreground-muted group-hover:text-foreground-lighter group-aria-selected:text-foreground",u&&"text-foreground-light","transition-colors")}):"schema"===e?(0,t.jsx)(s.GitBranch,{size:l,strokeWidth:c}):e===a.ENTITY_TYPE.VIEW?(0,t.jsx)(i.Eye,{size:l,strokeWidth:c,className:(0,r.cn)("text-foreground-muted group-hover:text-foreground-lighter",u&&"text-foreground-lighter","transition-colors")}):(0,t.jsx)("div",{className:(0,r.cn)("flex items-center justify-center text-xs h-4 w-4 rounded-[2px] font-bold",e===a.ENTITY_TYPE.FOREIGN_TABLE&&"text-warning-600/80 dark:text-yellow-900 bg-yellow-500",e===a.ENTITY_TYPE.MATERIALIZED_VIEW&&"text-purple-1100 bg-purple-500",e===a.ENTITY_TYPE.PARTITIONED_TABLE&&"text-foreground-light bg-surface-400 dark:bg-border-stronger"),children:Object.entries(a.ENTITY_TYPE).find(([,t])=>t===e)?.[0]?.[0]?.toUpperCase()})])},951684,e=>{"use strict";let t=(0,e.i(388019).default)("GitBranch",[["line",{x1:"6",x2:"6",y1:"3",y2:"15",key:"17qcm7"}],["circle",{cx:"18",cy:"6",r:"3",key:"1h7g24"}],["circle",{cx:"6",cy:"18",r:"3",key:"fqmcym"}],["path",{d:"M18 9a9 9 0 0 1-9 9",key:"n2h4wq"}]]);e.s(["default",()=>t])},300906,e=>{"use strict";var t=e.i(951684);e.s(["GitBranch",()=>t.default])},152285,e=>{"use strict";var t=e.i(478902),a=e.i(700856),i=e.i(389959),s=e.i(938933);let n=({defaultActiveId:e,activeId:n,type:r="pills",size:o="tiny",block:l,onChange:c,onClick:u,scrollable:d,wrappable:p,addOnBefore:m,addOnAfter:_,listClassNames:h,baseClassNames:b,refs:A,children:g})=>{let f=i.Children.toArray(g),[C,E]=(0,i.useState)(n??e??f?.[0]?.props?.id);(0,i.useMemo)(()=>{n&&n!==C&&E(n)},[n]);let y=(0,s.default)("tabs");function v(e){u?.(e),e!==C&&(c?.(e),E(e))}let x=[y[r].list];return d&&x.push(y.scrollable),p&&x.push(y.wrappable),h&&x.push(h),(0,t.jsxs)(a.Root,{value:C,className:[y.base,b].join(" "),ref:A?.base,children:[(0,t.jsxs)(a.List,{className:x.join(" "),ref:A?.list,children:[m,f.map(e=>{let i=C===e.props.id,s=[y[r].base,y.size[o]];return i?s.push(y[r].active):s.push(y[r].inactive),l&&s.push(y.block),(0,t.jsxs)(a.Trigger,{onKeyDown:t=>{"Enter"===t.key&&(t.preventDefault(),v(e.props.id))},onClick:()=>v(e.props.id),value:e.props.id,className:s.join(" "),children:[e.props.icon,(0,t.jsx)("span",{children:e.props.label}),e.props.iconRight]},`${e.props.id}-tab-button`)}),_]}),f]})};n.Panel=({children:e,id:i,className:n})=>{let r=(0,s.default)("tabs");return(0,t.jsx)(a.Content,{value:i,className:[r.content,n].join(" "),children:e})},e.s(["default",0,n])},200409,e=>{"use strict";var t=e.i(152285);e.s(["Tabs",()=>t.default])},238944,e=>{"use strict";var t=e.i(323796),a=e.i(898452),i=e.i(389959);function s({replace:e=!0,arrayKeys:n=[]}={}){let r=JSON.stringify(n),o=(0,i.useMemo)(()=>new Set(n),[r]),l=(0,a.useRouter)(),c=(0,i.useMemo)(()=>Object.fromEntries(Object.entries(l.query).map(([e,t])=>o.has(e)?Array.isArray(t)?[e,t]:[e,[t]]:[e,t])),[o,l.query]),u=(0,t.default)(c);return[c,(0,i.useCallback)(t=>{let a=u.current,i="function"==typeof t?t(a):t,s=Object.fromEntries(Object.entries({...a,...i}).filter(([,e])=>!!e));(e?l.replace:l.push)({pathname:l.pathname,query:s},void 0,{shallow:!0,scroll:!1})},[l,e])]}e.s(["useUrlState",()=>s])},990510,e=>{"use strict";e.i(128328);var t=e.i(947748),a=e.i(158639),i=e.i(124416);let s={editor:void 0,sql:void 0};e.s(["useDashboardHistory",0,()=>{let{ref:e}=(0,a.useParams)(),[n,r,{isSuccess:o}]=(0,i.useLocalStorageQuery)(t.LOCAL_STORAGE_KEYS.DASHBOARD_HISTORY(e??""),s);return{history:n,setLastVisitedTable:e=>{r({...n,editor:e})},setLastVisitedSnippet:e=>{r({...n,sql:e})},isHistoryLoaded:o}}])},839360,e=>{"use strict";let t=(0,e.i(388019).default)("PanelLeftClose",[["rect",{width:"18",height:"18",x:"3",y:"3",rx:"2",key:"afitv7"}],["path",{d:"M9 3v18",key:"fh3hqa"}],["path",{d:"m16 15-3-3 3-3",key:"14y99z"}]]);e.s(["PanelLeftClose",()=>t],839360)},249960,e=>{"use strict";let t=(0,e.i(388019).default)("PanelLeftOpen",[["rect",{width:"18",height:"18",x:"3",y:"3",rx:"2",key:"afitv7"}],["path",{d:"M9 3v18",key:"fh3hqa"}],["path",{d:"m14 9 3 3-3 3",key:"8010ee"}]]);e.s(["PanelLeftOpen",()=>t],249960)},569715,e=>{"use strict";var t=e.i(478902),a=e.i(95051);e.i(128328);var i=e.i(158639),s=e.i(63519),n=e.i(843778),r=e.i(825713),o=e.i(839360),l=e.i(249960),c=e.i(876298),u=e.i(613580);function d({hideTabs:e}){let{showSidebar:a,setShowSidebar:i}=(0,c.useAppStateSnapshot)();return(0,t.jsxs)(u.Tooltip,{children:[(0,t.jsx)(u.TooltipTrigger,{asChild:!0,children:(0,t.jsx)("button",{className:(0,n.cn)("flex items-center justify-center w-10 h-10 hover:bg-surface-100 shrink-0",!e&&"border-b border-b-default"),onClick:()=>i(!a),children:a?(0,t.jsx)(o.PanelLeftClose,{size:16,strokeWidth:1.5,className:"text-foreground-lighter hover:text-foreground-light"}):(0,t.jsx)(l.PanelLeftOpen,{size:16,strokeWidth:1.5,className:"text-foreground-lighter hover:text-foreground-light"})})}),(0,t.jsxs)(u.TooltipContent,{side:"bottom",children:[a?"Collapse":"Expand"," sidebar"]})]})}var p=e.i(731394),m=e.i(960547),_=e.i(809323),h=e.i(265100),b=e.i(479232),A=e.i(975924),g=e.i(898452),f=e.i(990510),C=e.i(62307),E=e.i(756441),y=e.i(917134),v=e.i(794965),x=e.i(500850),O=e.i(314805),N=e.i(408279),S=e.i(795826),T=e.i(84643),B=e.i(389959),w=e.i(528462),R=e.i(983783);let L=({tab:e,index:a,openTabs:i,onClose:r})=>{let o=(0,S.useEditorType)(),l=(0,s.useTabsStateSnapshot)(),{selectedSchema:c}=(0,R.useQuerySchemaState)(),{attributes:u,listeners:d,setNodeRef:p,transform:b,transition:g,isDragging:f}=(0,m.useSortable)({id:e.id}),C={transform:T.CSS.Transform.toString(b),transition:g,zIndex:+!!f},E=(0,B.useMemo)(()=>i.some(e=>"table"===o&&e.metadata?.schema!==c),[i,c,o]);return(0,t.jsxs)(h.motion.div,{ref:p,style:C,...u,layoutId:e.id,transition:{duration:.045},animate:{opacity:+!f},className:(0,n.cn)("flex items-center h-10 first-of-type:border-l"),children:[(0,t.jsxs)(N.TabsTrigger_Shadcn_,{value:e.id,onAuxClick:t=>{1===t.button&&(t.preventDefault(),r(e.id))},onDoubleClick:()=>l.makeTabPermanent(e.id),className:(0,n.cn)("flex items-center gap-2 pl-3 pr-2.5 text-xs","bg-dash-sidebar/50 dark:bg-surface-100/50","data-[state=active]:bg-dash-sidebar dark:data-[state=active]:bg-surface-100","border-b border-default","data-[state=active]:border-b-background-dash-sidebar dark:data-[state=active]:border-b-background-surface-100","relative group h-full","hover:bg-surface-300 dark:hover:bg-surface-100",e.isPreview&&"italic font-light"),...d,children:[(0,t.jsx)(w.EntityTypeIcon,{type:e.type}),(0,t.jsxs)("div",{className:"flex items-center gap-0",children:[(0,t.jsx)(_.AnimatePresence,{mode:"popLayout",initial:!0,children:E&&(0,t.jsxs)(h.motion.span,{initial:{opacity:0,width:0},animate:{opacity:1,width:"auto"},exit:{opacity:0,width:0},transition:{duration:.15},className:"text-foreground-muted group-data-[state=active]:text-foreground-lighter",children:[e?.metadata?.schema,"."]})}),(0,t.jsx)("span",{children:e.label||"Untitled"})]}),(0,t.jsx)("span",{role:"button",onClick:e=>{e.preventDefault(),e.stopPropagation()},className:"p-0.5 ml-1 opacity-0 group-hover:opacity-100 hover:bg-200 rounded-sm cursor-pointer",onMouseDown:e=>{e.preventDefault(),e.stopPropagation()},onPointerDown:t=>{t.preventDefault(),t.stopPropagation(),r(e.id)},children:(0,t.jsx)(A.X,{size:12,className:"text-foreground-light"})}),(0,t.jsx)("div",{className:"absolute w-full top-0 left-0 right-0 h-px bg-foreground opacity-0 group-data-[state=active]:opacity-100"})]}),a<i.length&&(0,t.jsx)("div",{role:"separator",className:"h-full w-px bg-border"},`separator-${e.id}`)]})},F=({tab:e})=>{let{ref:a}=(0,i.useParams)(),n=(0,s.useTabsStateSnapshot)().tabsMap[e];return n?(0,t.jsxs)(h.motion.div,{layoutId:e,transition:{duration:.045},animate:{opacity:.7},className:"flex relative items-center gap-2 px-3 text-xs bg-dash-sidebar dark:bg-surface-100 shadow-lg rounded-sm h-10",children:[(0,t.jsx)(w.EntityTypeIcon,{type:n.type}),(0,t.jsx)("span",{children:n.label||"Untitled"}),(0,t.jsx)("div",{className:"absolute w-full top-0 left-0 right-0 h-px bg-foreground-muted"})]}):null},D=()=>{let{ref:e,id:a}=(0,i.useParams)(),r=(0,g.useRouter)(),{setLastVisitedSnippet:o,setLastVisitedTable:l}=(0,f.useDashboardHistory)(),c=(0,S.useEditorType)(),u=(0,s.useTabsStateSnapshot)(),T=(0,p.useSensors)((0,p.useSensor)(p.PointerSensor,{activationConstraint:{distance:1}})),B=u.openTabs.map(e=>u.tabsMap[e]).filter(e=>void 0!==e),w=r.asPath.includes("/new"),R=c?B.filter(e=>s.editorEntityTypes[c]?.includes(e.type)):[],D=()=>{"table"===c?l(void 0):"sql"===c&&o(void 0)},k=e=>{u.handleTabClose({id:e,router:r,editor:c,onClearDashboardHistory:D})},I=()=>{if(c){let t="table"===c?u.openTabs.filter(e=>!e.startsWith("sql")):u.openTabs.filter(e=>e.startsWith("sql"));u.removeTabs(t),D(),r.push(`/project/${e}/${"table"===c?"editor":"sql"}`)}};return(0,t.jsxs)(p.DndContext,{sensors:T,onDragEnd:e=>{let{active:t,over:a}=e;if(!a||t.id===a.id)return;let i=u.openTabs.indexOf(t.id.toString()),s=u.openTabs.indexOf(a.id.toString());i!==s&&u.handleTabDragEnd(i,s,t.id.toString(),r)},children:[(0,t.jsxs)(x.Tabs_Shadcn_,{className:"w-full flex",value:w?"new":u.activeTab??void 0,onValueChange:e=>{u.handleTabNavigation(e,r)},children:[(0,t.jsx)(d,{hideTabs:!1}),(0,t.jsxs)(O.TabsList_Shadcn_,{className:(0,n.cn)("rounded-b-none gap-0 h-10 flex items-center w-full z-[1]","bg-surface-200 dark:bg-alternative border-none overflow-clip overflow-x-auto"),children:[(0,t.jsx)(m.SortableContext,{items:R.map(e=>e.id),strategy:m.horizontalListSortingStrategy,children:R.map((i,s)=>(0,t.jsxs)(C.ContextMenu_Shadcn_,{children:[(0,t.jsx)(v.ContextMenuTrigger_Shadcn_,{children:(0,t.jsx)(L,{tab:i,index:s,openTabs:B,onClose:()=>k(i.id)},i.id)}),(0,t.jsxs)(E.ContextMenuContent_Shadcn_,{children:[(0,t.jsx)(y.ContextMenuItem_Shadcn_,{onClick:()=>k(i.id),children:"Close"}),(0,t.jsx)(y.ContextMenuItem_Shadcn_,{onClick:()=>(t=>{if(c){let i="table"===c?u.openTabs.filter(e=>!e.startsWith("sql")&&e!==t):u.openTabs.filter(e=>e.startsWith("sql")&&e!==t);u.removeTabs(i),D();let s="table"===c?t.split("-")[1]:t.split("sql-")[1];a!==s&&r.push(`/project/${e}/${"table"===c?"editor":"sql"}/${s}`)}})(i.id),children:"Close Others"}),(0,t.jsx)(y.ContextMenuItem_Shadcn_,{onClick:()=>(t=>{if(c){let a="table"===c?u.openTabs.filter(e=>!e.startsWith("sql")):u.openTabs.filter(e=>e.startsWith("sql")),i=a.indexOf(t),s=a.indexOf(u.activeTab),n=a.slice(i+1);if(u.removeTabs(n),i<s){let a="table"===c?t.split("-")[1]:t.split("sql-")[1];r.push(`/project/${e}/${"table"===c?"editor":"sql"}/${a}`)}}})(i.id),children:"Close to the Right"}),(0,t.jsx)(y.ContextMenuItem_Shadcn_,{onClick:I,children:"Close All"})]})]},i.id))}),w&&(0,t.jsxs)(N.TabsTrigger_Shadcn_,{value:"new",className:(0,n.cn)("flex items-center gap-2 px-3 text-xs","bg-dash-sidebar/50 dark:bg-surface-100/50","data-[state=active]:bg-dash-sidebar dark:data-[state=active]:bg-surface-100","relative group h-full border-t-2 !border-b-0","hover:bg-surface-300 dark:hover:bg-surface-100"),children:[(0,t.jsx)(b.Plus,{size:16,strokeWidth:1.5,className:"text-foreground-lighter"}),(0,t.jsx)("div",{className:"flex items-center gap-0",children:(0,t.jsx)("span",{children:"New"})}),(0,t.jsx)("span",{role:"button",onClick:e=>{e.preventDefault(),e.stopPropagation()},className:"ml-1 opacity-0 group-hover:opacity-100 hover:bg-200 rounded-sm cursor-pointer",onMouseDown:e=>{e.preventDefault(),e.stopPropagation()},onPointerDown:e=>{e.preventDefault(),e.stopPropagation(),k("new")},children:(0,t.jsx)(A.X,{size:12,className:"text-foreground-light"})})," ",(0,t.jsx)("div",{className:"absolute w-full -bottom-[1px] left-0 right-0 h-px bg-dash-sidebar dark:bg-surface-100 opacity-0 group-data-[state=active]:opacity-100"})]}),(0,t.jsx)(_.AnimatePresence,{initial:!1,children:!w&&(0,t.jsx)(h.motion.button,{className:"flex items-center justify-center w-10 h-10 hover:bg-surface-100 shrink-0 border-b",onClick:()=>r.push(`/project/${r.query.ref}/${"table"===c?"editor":"sql"}/new?skip=true`),initial:{opacity:0,scale:.8,x:-10},animate:{opacity:1,scale:1,x:0},transition:{duration:.2},children:(0,t.jsx)(b.Plus,{size:16,strokeWidth:1.5,className:"text-foreground-lighter hover:text-foreground-light"})})}),(0,t.jsx)("div",{className:"grow h-full border-b pr-6"})]})]}),(0,t.jsx)(p.DragOverlay,{dropAnimation:null,children:u.activeTab?(0,t.jsx)(F,{tab:u.activeTab}):null})]})};e.s(["EditorBaseLayout",0,({children:e,title:o,product:l,productMenuClassName:c,productMenu:u})=>{let{ref:p}=(0,i.useParams)(),m=(0,a.usePathname)(),_=(0,S.useEditorType)(),h=(0,s.useTabsStateSnapshot)(),b="table"===_&&0===h.openTabs.filter(e=>!e.startsWith("sql")).length,A=m===`/project/${p}/editor`||m===`/project/${p}/sql`||b;return(0,t.jsx)(r.ProjectLayoutWithAuth,{resizableSidebar:!0,title:o,product:l,productMenuClassName:c,productMenu:u,children:(0,t.jsxs)("div",{className:"flex flex-col h-full",children:[(0,t.jsx)("div",{className:(0,n.cn)("h-10 flex items-center",A?"bg-surface-100":"bg-surface-200 dark:bg-alternative"),children:A?(0,t.jsx)(d,{hideTabs:A}):(0,t.jsx)(D,{})}),(0,t.jsx)("div",{className:"h-full",children:e})]})})}],569715)},556744,278889,e=>{"use strict";var t=e.i(478902),a=e.i(389959),i=e.i(903248);let s=(0,a.memo)(function(){return(0,t.jsx)("div",{className:"px-4 flex flex-col gap-0",children:[{width:"w-40",opacity:"opacity-100"},{width:"w-32",opacity:"opacity-100"},{width:"w-20",opacity:"opacity-75"},{width:"w-40",opacity:"opacity-50"},{width:"w-20",opacity:"opacity-25"}].map((e,a)=>(0,t.jsxs)("div",{className:`flex flex-row h-6 items-center gap-3 ${e.opacity}`,children:[(0,t.jsx)(i.Skeleton,{className:"h-4 w-5"}),(0,t.jsx)(i.Skeleton,{className:`h-4 ${e.width}`})]},a))})});e.s(["default",0,s],556744);var n=e.i(323796),r=e.i(63519);function o(){let e=(0,r.useTabsStateSnapshot)(),t=(0,n.default)(e.tabsMap),i=(0,n.default)(e.recentItems),s=(0,n.default)(e.openTabs);return(0,a.useCallback)(({schemas:a,entities:n})=>{let o=n.map(e=>(0,r.createTabId)(e.type,{id:e.id})),l=[];for(let e of a)l.push(...i.current.filter(t=>t.metadata?.schema===e).map(e=>e.id));let c=[...l.filter(e=>!o.includes(e))];e.removeRecentItems(c);let u=[];for(let e of a)u.push(...s.current.filter(a=>{let i=t.current[a];return i?.metadata?.schema===e}));let d=[...u.filter(e=>!e.startsWith("sql")&&!e.startsWith("schema")&&!o.includes(e))];e.removeTabs(d),s.current.map(e=>t.current[e]).filter(e=>!!e&&r.editorEntityTypes.table?.includes(e.type)).forEach(t=>{let a=n?.find(e=>t.metadata?.tableId===e.id);a&&a.name!==t.label&&e.updateTab(t.id,{label:a.name})})},[])}function l(){let e=(0,r.useTabsStateSnapshot)(),t=(0,n.default)(e.tabsMap),i=(0,n.default)(e.openTabs);return(0,a.useCallback)(({snippets:a})=>{let s=[...a.filter(e=>"sql"===e.type).map(e=>(0,r.createTabId)("sql",{id:e.id})),"sql-templates","sql-quickstarts"],n=i.current.filter(e=>e.startsWith("sql")&&!s.includes(e));e.removeTabs(n);let o=e.getRecentItemsByType("sql");e.removeRecentItems(o?o.filter(e=>!s.includes(e.id)).map(e=>e.id):[]),i.current.map(e=>t.current[e]).filter(e=>!!e&&r.editorEntityTypes.sql?.includes(e.type)).forEach(t=>{let i=a?.find(e=>t.metadata?.sqlId===e.id);i&&i.name!==t.label&&e.updateTab(t.id,{label:i.name})})},[])}e.s(["useSqlEditorTabsCleanup",()=>l,"useTableEditorTabsCleanUp",()=>o],278889)},384706,e=>{"use strict";let t=(0,e.i(388019).default)("Pointer",[["path",{d:"M22 14a8 8 0 0 1-8 8",key:"56vcr3"}],["path",{d:"M18 11v-1a2 2 0 0 0-2-2a2 2 0 0 0-2 2",key:"1agjmk"}],["path",{d:"M14 10V9a2 2 0 0 0-2-2a2 2 0 0 0-2 2v1",key:"wdbh2u"}],["path",{d:"M10 9.5V4a2 2 0 0 0-2-2a2 2 0 0 0-2 2v10",key:"1ibuk9"}],["path",{d:"M18 11a2 2 0 1 1 4 0v3a8 8 0 0 1-8 8h-2c-2.8 0-4.5-.86-5.99-2.34l-3.6-3.6a2 2 0 0 1 2.83-2.82L7 15",key:"g6ys72"}]]);e.s(["Pointer",()=>t],384706)},448761,457395,e=>{"use strict";var t=e.i(10429);let a=[{id:1,type:"template",title:"Create table",description:'Basic table template. Change "table_name" to the name you prefer.',sql:`create table table_name (
...
revoke execute on function public.custom_access_token_hook from authenticated, anon, public;
    `}];e.s(["SQL_TEMPLATES",0,a],448761);var i=e.i(478902),s=e.i(587433),n=e.i(627069);e.s(["ActionCard",0,e=>(0,i.jsx)(n.Card,{className:"grow bg-surface-100 p-3 transition-colors hover:bg-surface-200 border border-light hover:border-default cursor-pointer",onClick:e.onClick,children:(0,i.jsxs)("div",{className:"relative flex items-start gap-3",children:[e.isBeta&&(0,i.jsx)(s.Badge,{className:"absolute -right-5 -top-5 bg-surface-300 bg-opacity-100 text-xs text-foreground",children:"Coming soon"}),(0,i.jsx)("div",{className:`rounded-full ${e.bgColor} w-8 h-8 flex items-center justify-center flex-shrink-0`,children:e.icon}),(0,i.jsxs)("div",{className:"flex flex-col gap-0",children:[(0,i.jsx)("h3",{className:"text-sm text-foreground mb-0",children:e.title}),(0,i.jsx)("p",{className:"text-xs text-foreground-light",children:e.description})]})]})})],457395)}]);

//# debugId=485f2877-b4b2-261e-fce7-11590bc3947a
//# sourceMappingURL=98b23f5dffa41578.js.map